...
public class VoiceUriModel 
        implements java.io.Serializable {

    private int voiceUriId;
    private int backupUriId;
    ...
    /** GETTER
     * The identifier of the voice URI used as backup
     */
    @JsonGetter("backupUriId")
    public int getBackupUriId ( ) { 
    ...
    public void setBackupUriId (int value) { 
